...
public class DashboardBelajarBentuk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ...
                                mediaPlayers.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                                    ...
                                    public void onCompletion(MediaPlayer mediaPlayer) {
                                        mediaPlayers.reset();
                                        Intent intent = new Intent(getApplicationContext(),IsiBelajarBentuk.class);
        ...
        tebak_bentuk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tebak_bentuk.startAnimation(animation);
                animation.setAnimationListener(new Animation.AnimationListener() {
                    @Override
                    public void onAnimationStart(Animation animation) {
                        introPlayer.stop();
    ...
    {
        final Dialog dialog = new Dialog(DashboardBelajarBentuk.this);
