 ...
 * Use the {@link FragmentAllHewan#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentAllHewan extends Fragment {
     ...
     * @return A new instance of fragment FragmentAllHewan.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentAllHewan newInstance(String param1, String param2) {
        FragmentAllHewan fragment = new FragmentAllHewan();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_all_hewan, container, false);
            ...
            public void onClick(View view) {
                ...
                backAnimation.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationStart(Animation animation) {
                        ...
                        FragmentHewanEng fragmentHewanEng = new FragmentHewanEng();


                        if(getActivity() != null)
                        {
                            getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.splash,R.anim.splash_out).replace(R.id.frame,fragmentHewanEng).commit();
            ...
            public void onClick(View view) {
                ...
                backAnimation.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationStart(Animation animation) {
                        ...
                        FragmentHewanIndo fragmentHewanIndo = new FragmentHewanIndo();

                        if(getActivity() != null)
                        {
                            getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.splash,R.anim.splash_out).replace(R.id.frame,fragmentHewanIndo).commit();
