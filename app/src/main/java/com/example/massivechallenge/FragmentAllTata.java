 ...
 * Use the {@link FragmentAllTata#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentAllTata extends Fragment {
     ...
     * @return A new instance of fragment FragmentAllTata.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentAllTata newInstance(String param1, String param2) {
        FragmentAllTata fragment = new FragmentAllTata();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_all_tata, container, false);
            ...
            public void onClick(View view) {
                ...
                backAnimation.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationStart(Animation animation) {
                        ...
                        FragmentTataEng fragmentTataEng = new FragmentTataEng();


                        if(getActivity() != null)
                        {
                            getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.splash,R.anim.splash_out).replace(R.id.frame,fragmentTataEng).commit();
            ...
            public void onClick(View view) {
                ...
                backAnimation.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationStart(Animation animation) {
                        ...
                        FragmentTataIndo fragmentTataIndo = new FragmentTataIndo();

                        if(getActivity() != null)
                        {
                            getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.splash,R.anim.splash_out).replace(R.id.frame,fragmentTataIndo).commit();
