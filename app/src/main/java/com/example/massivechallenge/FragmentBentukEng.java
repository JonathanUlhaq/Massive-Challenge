 ...
 * Use the {@link FragmentBentukEng#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentBentukEng extends Fragment {
     ...
     * @return A new instance of fragment FragmentBentukEng.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentBentukEng newInstance(String param1, String param2) {
        FragmentBentukEng fragment = new FragmentBentukEng();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bentuk_eng, container, false);
...
//                adapterAbjadIndonesia.instantiateItem(container,position);
        ...
        next.setBackgroundResource(R.drawable.button_right_bentuk);
        previous = view.findViewById(R.id.previus);
        previous.setBackgroundResource(R.drawable.button_left_bentuk);
            ...
            public void onClick(View view) {
                ...
                backAnimation.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationStart(Animation animation) {
                        ...
                        FragmentBentukIndo fragmentBentukIndo = new FragmentBentukIndo();
                        fragmentBentukIndo.setArguments(bundle);

                        if(getActivity() != null)
                        {
                            getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.splash,R.anim.splash_out).replace(R.id.frame,fragmentBentukIndo).commit();
