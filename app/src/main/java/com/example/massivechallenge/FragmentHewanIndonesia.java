 ...
 * Use the {@link FragmentHewanIndonesia#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentHewanIndonesia extends Fragment {
    ...
    public static FragmentHewanIndonesia newInstance(String param1, String param2) {
        FragmentHewanIndonesia fragment = new FragmentHewanIndonesia();
    ...
    AdapterHewanIndonesia adapterHewanIndonesia;
    ViewPager viewPager;
    int posiss;
    Timer timer;
    Handler handler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hewan_indonesia, container, false);
        ...
        adapterHewanIndonesia = new AdapterHewanIndonesia(getContext());
        viewPager = view.findViewById(R.id.view_puager);
        viewPager.setAdapter(adapterHewanIndonesia);
                    ...
                    public void onClick(View view) {
                        ...
                        animation.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationStart(Animation animation) {
                                ...
                                FragmentHewanIndonesia indonesia = new FragmentHewanIndonesia();
            ...
            public void onClick(View view) {
                ...
                backAnimation.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationStart(Animation animation) {
                        ...
                        FragmentHewanInggris fragmentHewanInggris = new FragmentHewanInggris();
                        fragmentHewanInggris.setArguments(bundle);

                        if(getActivity() != null)
                        {
                            getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.splash,R.anim.splash_out).replace(R.id.frame,fragmentHewanInggris).commit();
