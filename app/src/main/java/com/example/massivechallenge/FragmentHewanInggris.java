 ...
 * Use the {@link FragmentHewanInggris#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentHewanInggris extends Fragment {
    ...
    public static FragmentHewanInggris newInstance(String param1, String param2) {
        FragmentHewanInggris fragment = new FragmentHewanInggris();
    ...
    AdapterHewanInggris adapterHewanInggris;
    ViewPager viewPager;
    int posiss;
    Timer timer;
    Handler handler;
    ...
    int[] suara = {
            R.raw.hewan_inggris_cat,
            R.raw.hewan_inggris_dog,
            R.raw.hewan_inggris_monkey,
            R.raw.hewan_inggris_bear,
            R.raw.hewan_inggris_cheetah,
            R.raw.hewan_inggris_eagle,
            R.raw.hewan_inggris_kangaroo,
            R.raw.hewan_inggris_rabbit,
            R.raw.hewan_inggris_panda,
            R.raw.hewan_inggris_cow,
            R.raw.hewan_inggris_lion,
            R.raw.hewan_inggris_camel,
            R.raw.hewan_indo_zebra,
            R.raw.hewan_inggris_duck,
            R.raw.hewan_inggris_frog,
            R.raw.hewan_inggris_bat,
            R.raw.hewan_inggris_hedgehog,
            R.raw.hewan_inggris_deer,
            R.raw.hewan_inggris_snail,
            R.raw.hewan_inggris_chicken,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hewan_inggris, container, false);
        ...
        adapterHewanInggris = new AdapterHewanInggris(getContext());
        viewPager = view.findViewById(R.id.view_puager);
        viewPager.setAdapter(adapterHewanInggris);
                    ...
                    public void onClick(View view) {
                        ...
                        animation.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationStart(Animation animation) {
                                ...
                                FragmentHewanInggris inggris = new FragmentHewanInggris();
            ...
            public void onClick(View view) {
                ...
                backAnimation.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationStart(Animation animation) {
                        ...
                        FragmentHewanIndonesia fragmentHewanIndonesia = new FragmentHewanIndonesia();
                        fragmentHewanIndonesia.setArguments(bundle);

                        if(getActivity() != null)
                        {
                            getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.splash,R.anim.splash_out).replace(R.id.frame,fragmentHewanIndonesia).commit();
