 ...
 * Use the {@link FragmentPlanetInggris#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentPlanetInggris extends Fragment {
     ...
     * @return A new instance of fragment FragmentPlanetInggris.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentPlanetInggris newInstance(String param1, String param2) {
        FragmentPlanetInggris fragment = new FragmentPlanetInggris();
    ...
    AdapterPlanetInggris adapterPlanetInggris;
    ViewPager viewPager;
    int posisiss;
    Timer timer;
    Handler handler;
    ...
    int[] suara = {
            R.raw.sun_tata_inggris,
            R.raw.moon_tata_inggris,
            R.raw.mercury_tata_inggris,
            R.raw.venus_tata_inggris,
            R.raw.earth_tata_inggris,
            R.raw.mars_tata_inggris,
            R.raw.jupiter_tata_inggris,
            R.raw.saturn_tata_inggris,
            R.raw.uranus_tata_inggris,
            R.raw.neptune2_tata_inggris,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_planet_inggris, container, false);
        ...
        adapterPlanetInggris = new AdapterPlanetInggris(getContext());
        viewPager = view.findViewById(R.id.view_puager);
        viewPager.setAdapter(adapterPlanetInggris);
                    ...
                    public void onClick(View view) {
                        ...
                        animation.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationStart(Animation animation) {
                                ...
                                FragmentPlanetInggris inggris = new FragmentPlanetInggris();
            ...
            public void onClick(View view) {
                ...
                backAnimation.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationStart(Animation animation) {
                        ...
                        FragmentPlanetIndonesia fragmentPlanetIndonesia = new FragmentPlanetIndonesia();
                        fragmentPlanetIndonesia.setArguments(bundle);

                        if(getActivity() != null)
                        {
                            getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.splash,R.anim.splash_out).replace(R.id.frame,fragmentPlanetIndonesia).commit();
