 ...
 * Use the {@link FragmentSayurEng#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentSayurEng extends Fragment {
     ...
     * @return A new instance of fragment FragmentSayurEng.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentSayurEng newInstance(String param1, String param2) {
        FragmentSayurEng fragment = new FragmentSayurEng();
    ...
    AdapterSayurEng adapterSayurEng;
    ViewPager viewPager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sayur_eng, container, false);
        ...
        adapterSayurEng = new AdapterSayurEng(getContext());
        viewPager = view.findViewById(R.id.view_puager);
        viewPager.setAdapter(adapterSayurEng);
                    ...
                    public void onClick(View view) {
                        ...
                        backAnimation.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationStart(Animation animation) {
                                ...
                                FragmentSayurIndo fragmentSayurIndo = new FragmentSayurIndo();
                                fragmentSayurIndo.setArguments(bundle);

                                if(getActivity() != null)
                                {
                                    getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.splash,R.anim.splash_out).replace(R.id.frame,fragmentSayurIndo).commit();
