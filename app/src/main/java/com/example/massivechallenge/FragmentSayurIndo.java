 ...
 * Use the {@link FragmentSayurIndo#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentSayurIndo extends Fragment {
     ...
     * @return A new instance of fragment FragmentSayurIndo.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentSayurIndo newInstance(String param1, String param2) {
        FragmentSayurIndo fragment = new FragmentSayurIndo();
    ...
    AdapterSayurIndo adapterSayurIndo;
    ViewPager viewPager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sayur_indo, container, false);
        ...
        adapterSayurIndo = new AdapterSayurIndo(getContext());
        viewPager = view.findViewById(R.id.view_puager);
        viewPager.setAdapter(adapterSayurIndo);
                    ...
                    public void onClick(View view) {
                        ...
                        backAnimation.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationStart(Animation animation) {
                                ...
                                FragmentSayurEng fragmentSayurEng = new FragmentSayurEng();
                                fragmentSayurEng.setArguments(bundle);

                                if(getActivity() != null)
                                {
                                    getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.splash,R.anim.splash_out).replace(R.id.frame,fragmentSayurEng).commit();
