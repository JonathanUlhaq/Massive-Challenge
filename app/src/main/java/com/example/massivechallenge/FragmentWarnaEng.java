 ...
 * Use the {@link FragmentWarnaEng#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentWarnaEng extends Fragment {
     ...
     * @return A new instance of fragment FragmentWarnaEng.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentWarnaEng newInstance(String param1, String param2) {
        FragmentWarnaEng fragment = new FragmentWarnaEng();
    ...
    AdapterWarnaEng adapterWarnaEng;
    ViewPager viewPager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_warna_eng, container, false);
        ...
        adapterWarnaEng = new AdapterWarnaEng(getContext());
        viewPager = view.findViewById(R.id.view_puager);
        viewPager.setAdapter(adapterWarnaEng);
                    ...
                    public void onClick(View view) {
                        ...
                        backAnimation.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationStart(Animation animation) {
                                ...
                                FragmentWarnaIndo fragmentWarnaIndo= new FragmentWarnaIndo();
                                fragmentWarnaIndo.setArguments(bundle);

                                if(getActivity() != null)
                                {
                                    getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.splash,R.anim.splash_out).replace(R.id.frame,fragmentWarnaIndo).commit();
