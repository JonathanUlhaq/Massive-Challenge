 ...
 * Use the {@link FragmentWarnaIndo#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentWarnaIndo extends Fragment {
     ...
     * @return A new instance of fragment FragmentWarnaIndo.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentWarnaIndo newInstance(String param1, String param2) {
        FragmentWarnaIndo fragment = new FragmentWarnaIndo();
    ...
    AdapterWarnaIndo adapterWarnaIndo;
    ViewPager viewPager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_warna_indo, container, false);
        ...
        adapterWarnaIndo = new AdapterWarnaIndo(getContext());
        viewPager = view.findViewById(R.id.view_puager);
        viewPager.setAdapter(adapterWarnaIndo);
                    ...
                    public void onClick(View view) {
                        ...
                        backAnimation.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationStart(Animation animation) {
                                ...
                                FragmentWarnaEng fragmentWarnaEng = new FragmentWarnaEng();
                                fragmentWarnaEng.setArguments(bundle);

                                if(getActivity() != null)
                                {
                                    getActivity().getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.splash,R.anim.splash_out).replace(R.id.frame,fragmentWarnaEng).commit();
