...
public class TebakBentukIndo extends AppCompatActivity {
    ...
    public void generateSoal() {
        ...
        Animation animationImage = AnimationUtils.loadAnimation(TebakBentukIndo.this, R.anim.unlimited_bouncing);
        Animation animationBayangan = AnimationUtils.loadAnimation(TebakBentukIndo.this, R.anim.unlimited_bouncing_shadow);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tebak_bentuk_indo);
        ...
        Animation animation = AnimationUtils.loadAnimation(TebakBentukIndo.this, R.anim.splash);
            ...
            public void onClick(View view) {
                ...
                animation.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationStart(Animation animation) {
                        MediaPlayer mediaPlayer = MediaPlayer.create(TebakBentukIndo.this, R.raw.click_sound_effect);
                        mediaPlayer.start();
                        ...
                        Intent intent = new Intent(TebakBentukIndo.this, DashboardBelajarBentuk.class);
    ...
    public void Jawaban(View view) {
        final Dialog dialog = new Dialog(TebakBentukIndo.this);
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                if (view.getTag().toString().equals(Integer.toString(lokasiJawaban))) {
                    ...
                    MediaPlayer mediaPlayer = MediaPlayer.create(TebakBentukIndo.this,R.raw.hebat);
                    mediaPlayer.start();
                    mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        @Override
                        public void onCompletion(MediaPlayer mediaPlayer) {
                    ...
                    new CountDownTimer(3000, 1000) {
                        ...
                        public void onFinish() {
                            ...
                            if (nomorSoal == 10) {
                                Dialog result = new Dialog(TebakBentukIndo.this);
                    ...
                    MediaPlayer mediaPlayer = MediaPlayer.create(TebakBentukIndo.this,R.raw.oops);
                    mediaPlayer.start();
                    mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        @Override
                        public void onCompletion(MediaPlayer mediaPlayer) {
