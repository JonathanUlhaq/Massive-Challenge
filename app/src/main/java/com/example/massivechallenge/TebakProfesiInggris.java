        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                if (view.getTag().toString().equals(Integer.toString(lokasiJawaban))) {
                    ...
                    MediaPlayer mediaPlayer = MediaPlayer.create(TebakProfesiInggris.this,R.raw.hebat);
                    mediaPlayer.start();
                    mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        @Override
                        public void onCompletion(MediaPlayer mediaPlayer) {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        animation.setAnimationListener(new Animation.AnimationListener() {
                                            ...
                                            public void onAnimationStart(Animation animation) {
                                                ...
                                                Intent intent = new Intent(TebakProfesiInggris.this, DasboardBelajarAngka.class);
                                                startActivity(intent);
                                            }
                    ...
                    MediaPlayer mediaPlayer = MediaPlayer.create(TebakProfesiInggris.this,R.raw.oops);
                    mediaPlayer.start();
                    mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        @Override
                        public void onCompletion(MediaPlayer mediaPlayer) {
