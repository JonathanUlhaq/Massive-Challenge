...
public class TebakWarnaInggris extends AppCompatActivity {
    ...
    public void generateSoal() {
        ...
        Animation animationImage = AnimationUtils.loadAnimation(TebakWarnaInggris.this, R.anim.unlimited_bouncing);
        Animation animationBayangan = AnimationUtils.loadAnimation(TebakWarnaInggris.this, R.anim.unlimited_bouncing_shadow);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tebak_warna_inggris);
        ...
        Animation animation = AnimationUtils.loadAnimation(TebakWarnaInggris.this, R.anim.splash);
    ...
    public void Jawaban(View view) {
        final Dialog dialog = new Dialog(TebakWarnaInggris.this);
                ...
                if (view.getTag().toString().equals(Integer.toString(lokasiJawaban))) {
                    ...
                    new CountDownTimer(3000, 1000) {
                        ...
                        public void onFinish() {
                            ...
                            if (nomorSoal == 10) {
                                Dialog result = new Dialog(TebakWarnaInggris.this);
